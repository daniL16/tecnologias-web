function formMiembro(datos){
    console.log(datos)
    let list = document.getElementById('contenido');
    list.innerHTML= '';
    list.insertAdjacentHTML=('beforeend',`<form  id='registro' method=post action='./php/editarMiembro.php' onsubmit='return validar_miembro();' >
