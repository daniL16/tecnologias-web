...
<article id="contenido">
        <form  id="registro" method=post action="./php/nuevoProyecto.php" onsubmit="" >
            ...
            <label>Fecha comienzo</label><input type="date" class="fechas" name="fecha_com"><br>
            <label>Fecha fin</label><input type="date"  class="fechas" name="fecha_fin" id="fecha_fin"><br>
